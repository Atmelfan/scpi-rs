...
pub type SensVoltDcAper<const N: usize = 1> = aperture::SenseApertureCommand<VoltageDc, N>;
#[cfg(feature = "unit-ratio")]
pub type SensVoltDcNplc<const N: usize = 1> = nplc::SenseNPLCyclesCommand<VoltageDc, N>;
...
#[cfg(feature = "unit-time")]
pub type SensVoltAcAper<const N: usize = 1> = aperture::SenseApertureCommand<VoltageAc, N>;
#[cfg(feature = "unit-ratio")]
pub type SensVoltAcNplc<const N: usize = 1> = nplc::SenseNPLCyclesCommand<VoltageAc, N>;
