...
use crate::{
    ...
    parser::{mnemonic_compare, parameters::parser_unreachable, tokenizer::Token},
};
...
impl<T> NumericValue<T> {
    ...
    ///
    /// ```
    /// # use scpi::scpi1999::numeric::NumericValue;
    ...
    /// Shorthand for
    /// ```
    /// # use scpi::scpi1999::NumericValue;
...
impl<'a> TryFrom<Token<'a>> for NumericValue<()> {
    type Error = Error;
